...
public interface HMap
{
     ...
     * only if this map contains at a mapping for a key k such that (key==null ? k==null : key.equals(k)).
     ...
     * is modified while an iteration over the set is in progress, the results of the iteration are undefined.
     ...
     * and the two Maps represent the same mappings. More formally, two maps t1 and t2 represent the same mappings
     ...
     * mapping for this key. A return value of null does not necessarily indicate that the map contains
     ...
     * This ensures that t1.equals(t2) implies that t1.hashCode()==t2.hashCode() for any
     ...
     * for each mapping from key k to value v in the specified map. The behavior of this operation
     * is unspecified if the specified map is modified while the operation is in progress.
     *
     * @param t - Mappings to be stored in this map.
     * @throws NullPointerException - the specified map is null, or if this map does not permit
     ...
     * if it is present (optional operation). More formally, if this map contains a mapping from
     ...
     * Returns the value to which the map previously associated the key, or null if the map contained
     * no mapping for this key. (A null return can also indicate that the map previously associated null
     * with the specified key if the implementation supports null values.) The map will not contain a mapping
     ...
     * of the iteration are undefined. The collection supports element removal, which
    ...
    interface Entry
    {
         ...
         *
         * @param value value - new value to be stored in this entry.
         * @return old value corresponding to the entry.
         * @throws java.lang.NullPointerException - the backing map does not permit null values, and the specified value is null.
         */
