 ...
 * Declarations for other inherited methods are also included here for convenience. (The specifications
 * accompanying these declarations have been tailored to the Set interface, but they do not contain any
 * additional stipulations.)
 * <p>
 * The additional stipulation on constructors is, not surprisingly, that all constructors must create a set
 * that contains no duplicate elements (as defined above).
 * <p>
 ...
 * object is an element in the set. A special case of this prohibition is that it is not permissible for a
 ...
 * or ClassCastException. Attempting to query the presence of an ineligible element may throw an exception,
 ...
 * result in the insertion of an ineligible element into the set may throw an exception or it may succeed,
 * at the option of the implementation. Such exceptions are marked as "optional" in the specification for
 * this interface.
 */
...
public interface HSet extends HCollection
{
     ...
     * More formally, adds the specified element, o, to this set if this set contains no element e
     * such that (o==null ? e==null : o.equals(e)). If this set already contains the specified element,
     ...
     * particular element, including null, and throwing an exception, as described in the specification for
     * Collection.add. Individual set implementations should clearly document any restrictions on the the
     ...
     * present (optional operation). If the specified collection is also a set, the addAll operation
     * effectively modifies this set so that its value is the union of the two sets. The behavior of
     * this operation is unspecified if the specified collection is modified while the operation is in progress.
     *
     * @param c - collection whose elements are to be added to this set.
     * @return true if this set changed as a result of the call.
     * @throws NullPointerException - if the specified collection contains one or more null elements and this set does
     *                              not support null elements, or if the specified collection is null.
     */
    boolean addAll(HCollection c);

    /**
     * Removes all of the elements from this set (optional operation). This set will be empty after this
     ...
     * is also a set, the two sets have the same size, and every member of the specified set is contained
     * in this set (or equivalently, every member of this set is contained in the specified set).
     ...
     * the hash codes of the elements in the set, where the hashcode of a null element is defined to
     * be zero. This ensures that s1.equals(s2) implies that s1.hashCode()==s2.hashCode() for any two
     * sets s1 and s2, as required by the general contract of the Object.hashCode method.
     *
     ...
     *
     * @return isEmpty in interface Collection
     */
    boolean isEmpty();
     ...
     * removes an element e such that (o==null ? e==null : o.equals(e)), if the set contains such an element.
     ...
     * @return true if this set changed as a result of the call.
     * @throws NullPointerException - if this set contains a null element and the specified collection does not support null elements,if the specified collection is null.
     */
     ...
     *
     * @param a - the array into which the elements of this set are to be stored, if it is big enough; otherwise,
