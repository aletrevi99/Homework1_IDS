...
public class ListAdapterTester
{
    ...
    /**
     * Crea una nuova ListAdapter prima di ogni test.
     */
    @Before
     ...
     * verrà correttamente aggiunta, altrimenti false.
     */
    @Test
     ...
     * verranno correttamente aggiunte, altrimenti false.
     */
    @Test
     ...
     * <b>Post-Condizioni</b>: la lista torna ad essere vuota e di dimensione zero.
     * <br><br>
     * <b>Risultato Atteso</b>: Il metodo ritornerà l'hashcode corretto della lista sotto forma di int.
     */
    @Test
     ...
     * <b>Post-Condizioni</b>: la lista torna ad essere vuota e di dimensione zero.
     * <br><br>
     * <b>Risultato Atteso</b>: Il metodo ritornerà l'oggetto nella posizione index se quest'ultima è una posizione valida.
     */
    @Test
    public void getTest()
    {
     ...
     * <b>Post-Condizioni</b>: la lista torna ad essere vuota e di dimensione zero.
     * <br><br>
     * <b>Risultato Atteso</b>: Il metodo ritornerà l'indice del primo oggetto (passato come argomento) presente in questa lista
     ...
     * <br><br>
     * <b>Sommario</b>: Creo un ListAdapter test con il metodo privato getACollection() e lo uso per riempire list. Con due for,
     * uno per tipo di oggetto di list, controllo che il metodo lastIndexOf ritorni l'indice dell'ultimo elemento effettivamente
     * contenuto nella lista all'indice i. Controllo che se passo come argomento un oggetto non contenuto nella lista,
     ...
     * <b>Post-Condizioni</b>: la lista torna ad essere vuota e di dimensione zero.
     * <br><br>
     * <b>Risultato Atteso</b>: Il metodo ritornerà l'indice dell'ultimo oggetto (passato come argomento) presente in questa lista
     ...
     * rimuova effettivamente l'ultimo oggetto controllato da test1 controllando che la dimensione della lista sia
     * diminuita e che l'ultimo oggetto della lista non sia più contenuto in essa. Verifico che se viene invocato
     * il metodo next() di un listIterator arrivato a fine lista o se invoco il metodo remove ripetutamente, vengono lanciate
     * le relative eccezioni. Aggiungo l'oggetto "pippo" per testare il metodo add() e verifico che la dimensione sia aumentata di uno
     ...
     * la lista in entrambi i sensi e di agire su di essa. Gestisce correttamente le eccezioni.
     */
    @Test
    public void listIteratorTest()
    {
        ...
        assertEquals(list.size(), test1.nextIndex());
        assertEquals(list.size() - 1, test1.previousIndex());
     ...
     * <br><br>
     * <b>Sommario</b>: Creo un listIterator di list e controllo che non sia nullo. Aggiungo dentro a list gli elementi di un
     * ListAdapter creato con il metodo privato getACollection() e creo un nuovo listIterator test di list dall'indice 5.
     * Scorro test con un while per verificare che gli oggetti ispezionati da test siano effettivamenti quelli della list
     ...
     * che esso agisca effettivamente sulla lista su cui è stato creato dall'indice scelto e che gestisca correttamente l'eccezione.
     * <br><br>
     * <b>Pre-condizioni</b>: oggetto di tipo ListAdapter correttamente inizializzato con dimensione uguale a zero e che il
     ...
     * <b>Post-Condizioni</b>: la lista torna ad essere vuota e di dimensione zero.
     * <br><br>
     * <b>Risultato Atteso</b>: Il metodo ritorna un nuovo listIteratore di list, a partire dall'indice scelto,
     ...
     * aggiungo tutti gli elementi di test ad essa, verifico che ritorni true se invoco remove per un oggetto presente
     ...
     * Object della dimensione di list e ci copio all'interno un elemento di list per ogni iterazione del for. Infine
     ...
     * Object; il primo, test,  della dimensione di list, il secondo, test1, della dimensione di list + 5 e il terzo,
